...
For my SoftUni final project in Machine Learning for the May 2026 course, this structure demonstrates that assumptions, model logic, and explanatory notebooks are deliberately separated.
